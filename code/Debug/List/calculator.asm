...
; 0000 003B                 first_operand = first_operand * 10 + button;
	CALL SUBOPT_0x0
	CALL SUBOPT_0x1
	STS  _first_operand,R30
	STS  _first_operand+1,R31
	STS  _first_operand+2,R22
	STS  _first_operand+3,R23
; 0000 003C             }else {
	RJMP _0x32
_0x31:
; 0000 003D                 second_operand = second_operand * 10 + button;
	CALL SUBOPT_0x2
	CALL SUBOPT_0x1
	STS  _second_operand,R30
	STS  _second_operand+1,R31
	STS  _second_operand+2,R22
	STS  _second_operand+3,R23
; 0000 003E             }
_0x32:
...
; 0000 0055             return first_operand-second_operand;
	LDS  R26,_second_operand
	LDS  R27,_second_operand+1
	LDS  R24,_second_operand+2
	LDS  R25,_second_operand+3
	CALL SUBOPT_0x0
	CALL __SUBD12
	RET
; 0000 0056         case '*':
...
; 0000 006C     first_operand=0;
	LDI  R30,LOW(0)
	STS  _first_operand,R30
	STS  _first_operand+1,R30
	STS  _first_operand+2,R30
	STS  _first_operand+3,R30
; 0000 006D     second_operand=0;
	STS  _second_operand,R30
	STS  _second_operand+1,R30
	STS  _second_operand+2,R30
	STS  _second_operand+3,R30
...
SUBOPT_0x0:
	LDS  R30,_first_operand
	LDS  R31,_first_operand+1
	LDS  R22,_first_operand+2
	LDS  R23,_first_operand+3
	RET
...
SUBOPT_0x2:
	LDS  R30,_second_operand
	LDS  R31,_second_operand+1
	LDS  R22,_second_operand+2
	LDS  R23,_second_operand+3
	RET

;OPTIMIZER ADDED SUBROUTINE, CALLED 3 TIMES, CODE SIZE REDUCTION:13 WORDS
SUBOPT_0x3:
	RCALL SUBOPT_0x2
	LDS  R26,_first_operand
	LDS  R27,_first_operand+1
	LDS  R24,_first_operand+2
	LDS  R25,_first_operand+3
	RET
